...
class login_page:
    def __init__(self, window):
        ...
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#98a65d', cursor="hand2",command=self.redirect_window,
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN',command=self.login_func,font=("yu gothic ui", 13, "bold"), width=25, bd=0,
        ...
        self.forgot_button = Button(self.lgn_frame, text="Forgot Password ?",
                                    font=("yu gothic ui", 13, "bold underline"), fg="white", relief=FLAT,command=self.forgot_func,
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Sign Language Recognization",parent=self.window)
